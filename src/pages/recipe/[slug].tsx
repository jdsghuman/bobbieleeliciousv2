...
const Recipe = ({ recipe, morePosts, ratingValue, ratingCount }: RecipePageProps) => {
  ...
  const postMetaTags: MetaTags = {
    ...
    title: `${recipe.fields.title} | Bobbieleelicious`,
  ...
  const jsonLd = {
    ...
    image: recipe.fields.image,
    description,
    ...(recipe.fields.publishDate && { datePublished: recipe.fields.publishDate }),
    ...(recipe.sys.updatedAt && { dateModified: recipe.sys.updatedAt }),
    author: {
      '@type': 'Person',
      name: authorName,
    },
